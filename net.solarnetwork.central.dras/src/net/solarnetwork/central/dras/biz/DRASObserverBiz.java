 ...
 * 
 * <p>
 * All methods assume any necessary security filtering and authorization are
 * handled in the implementation, and access to the active user of the API can
...
public interface DRASObserverBiz {
	 ...
	 * {@code name}, in an ascending manner.
	 * </p>
	 * 
	...
	/**
	 * Get the members of a participant group, optionally filtered or sorted in
	 * some way.
	 * 
	 * <p>
	 * If specific ordering is required, the {@code sortDescriptors} parameter
	 ...
	 * sort order by way of iteration over the set's items.
	 * </p>
	 * 
	 * @param groupId
	 ...
	 * @param sortDescriptors
	 *        an optional list of sort descriptors to order the results by
	 * @return set of participant group member identities, or an empty set if
	 *         none found
	 */
	 ...
	 * 
	 * @param program
	 *        the program to get participants for
	 * @param criteria
	 *        an optional search criteria
	 * @param sortDescriptors
	 *        an optional list of sort descriptors to order the results by
	...
	/**
	 * Get a list of Events, optionally filtered by a search criteria and
	 ...
	 * property names. If no {@code sortDescriptors} are provided, the results
	 * will be sorted by {@code created}, in a descending manner.
	 * </p>
	 * 
	 * @param program
	 *        the program to get events for
	 * @param criteria
	 *        an optional search criteria
	 * @param sortDescriptors
	 *        an optional list of sort descriptors to order the results by
	 * @return list of programs, or an empty list if none found
	 */
	List<Event> getEvents(Program program, ObjectCriteria<EventFilter> criteria,
	 ...
	 * 
	 * @param event
	 *        the event to get participant groups for
	 * @return current EventParticipants entity
	 */
	EventParticipants getCurrentEventParticipants(Event event);

	/**
	 * Get the current set of participants participating in a given event,
	 * optionally filtered by a search criteria or sorted in some way.
	 * 
	 * <p>
	 * The results will contain the union of all participants and participants
	 * of groups assigned to the given Event.
	 * </p>
	 * 
	 * <p>
	 * If specific ordering is required, the {@code sortDescriptors} parameter
	 * can be used to sort the results, where sort keys are
	 * {@link net.solarnetwork.central.domain.NodeInformation} property names.
	 ...
	 * 
	 * @param event
	 *        the event to get participants for
	 * @param criteria
	 *        an optional search criteria
	 * @param sortDescriptors
	 *        an optional list of sort descriptors to order the results by
	 ...
	 * 
	 * @param event
	 *        the event to get the targets for
