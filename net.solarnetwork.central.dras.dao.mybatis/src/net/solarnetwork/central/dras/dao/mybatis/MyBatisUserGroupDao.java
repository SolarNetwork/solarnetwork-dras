/* ==================================================================
 * MyBatisUserGroupDao.java - Jun 5, 2011 3:30:29 PM
 * 
...
/**
 * MyBatis implementation of {@link UserGroupDao}.
 * 
 * @author matt
 * @version 1.0
 */
public class MyBatisUserGroupDao extends
		DrasMyBatisFilterableDaoSupport<UserGroup, Match, UserGroupFilter> implements UserGroupDao {

	/**
	 * Default constructor.
	 */
	public MyBatisUserGroupDao() {
	...
	public void assignMembers(final Long groupId, final Set<Long> userIdSet, final Long effectiveId) {
