/* ==================================================================
 * MyBatisProgramDao.java - Jun 3, 2011 3:36:52 PM
 * 
...
/**
 * MyBatis implementation of {@link ProgramDao}.
 * 
 * @author matt
 * @version 1.0
 */
public class MyBatisProgramDao extends DrasMyBatisFilterableDaoSupport<Program, Match, ProgramFilter>
		implements ProgramDao {

	/**
	 * Default constructor.
	 */
	public MyBatisProgramDao() {
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.REQUIRED)
	public Set<Member> getParticipantMembers(Long programId, DateTime effectiveDate) {
		return getMemberSet(programId, Participant.class, effectiveDate);
	}

	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void assignParticipantMembers(final Long programId, final Set<Long> participantIdSet,
			final Long effectiveId) {
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.REQUIRED)
	public Set<EventRule> getProgramEventRules(Long programId, DateTime effectiveDate) {
		return getRelatedSet(programId, EventRule.class, effectiveDate);
	}

	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void assignProgramEventRules(Long programId, Set<Long> eventRuleIdSet, Long effectiveId) {
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void assignConstraints(Long programId, Set<Long> constraintIdSet, Long effectiveId) {
