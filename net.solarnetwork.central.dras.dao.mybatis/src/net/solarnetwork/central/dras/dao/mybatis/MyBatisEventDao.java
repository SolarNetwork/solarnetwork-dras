/* ==================================================================
 * MyBatisEventDao.java - Jun 7, 2011 6:38:01 PM
 * 
...
/**
 * MyBatis implementation of {@link EventDao}.
 * 
 * @author matt
 * @version 1.0
 */
public class MyBatisEventDao extends DrasMyBatisFilterableDaoSupport<Event, Match, EventFilter>
		implements EventDao {

	/**
	 * Default constructor.
	 */
	public MyBatisEventDao() {
		super(Event.class, Match.class);
	}

	@Override
	protected void postProcessFilterProperties(EventFilter filter, Map<String, Object> sqlProps) {
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.REQUIRED)
	public Set<Member> getUserGroupMembers(Long eventId, DateTime effectiveDate) {
		return getMemberSet(eventId, UserGroup.class, effectiveDate);
	}

	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void assignUserGroupMembers(Long eventId, Set<Long> userGroupIdSet, Long effectiveId) {
		storeMemberSet(eventId, UserGroup.class, userGroupIdSet, effectiveId);
	}

	@Override
	@Transactional(readOnly = true, propagation = Propagation.REQUIRED)
	public Set<Member> getParticipantMembers(Long eventId, DateTime effectiveDate) {
		return getMemberSet(eventId, Participant.class, effectiveDate);
	}

	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void assignParticipantMembers(Long eventId, Set<Long> participantIdSet, Long effectiveId) {
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.REQUIRED)
	public Set<Member> getParticipantGroupMembers(Long eventId, DateTime effectiveDate) {
		return getMemberSet(eventId, ParticipantGroup.class, effectiveDate);
	}

	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void assignParticipantGroupMembers(Long eventId, Set<Long> participantGroupIdSet,
			Long effectiveId) {
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void assignEventTargets(Long eventId, Set<Long> targetsIdSet, Long effectiveId) {
		storeRelatedSet(eventId, EventTargets.class, targetsIdSet, effectiveId);
	}

	@Override
	@Transactional(readOnly = true, propagation = Propagation.REQUIRED)
	public Set<EventExecutionTargets> getEventExecutionTargets(Long eventId, DateTime effectiveDate) {
