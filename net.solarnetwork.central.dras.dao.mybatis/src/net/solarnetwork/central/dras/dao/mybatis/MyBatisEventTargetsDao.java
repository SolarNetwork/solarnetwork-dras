/* ==================================================================
 * MyBatisEventTargetsDao.java - Jun 6, 2011 8:21:41 PM
 * 
...
/**
 * MyBatis implementation of {@link EventTargetsDao}.
 * 
 * @author matt
 * @version 1.0
 */
public class MyBatisEventTargetsDao extends DrasMyBatisGenericDaoSupport<EventTargets>
		implements EventTargetsDao {

	/**
	 * Default constructor.
	 */
	public MyBatisEventTargetsDao() {
