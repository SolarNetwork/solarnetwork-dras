/* ==================================================================
 * MyBatisParticipantDao.java - Jun 6, 2011 12:57:45 PM
 * 
...
/**
 * MyBatis implementation of {@link ParticipantDao}.
 * 
 * @author matt
 * @version 1.0
 */
public class MyBatisParticipantDao
		extends DrasMyBatisFilterableDaoSupport<Participant, Match, ParticipantFilter>
		implements ParticipantDao {

	/**
	 * Default constructor.
	 */
	public MyBatisParticipantDao() {
		super(Participant.class, Match.class);
	}

	@Override
	protected String getFilteredQuery(String filterDomain, ParticipantFilter filter) {
	...
	public Set<Constraint> getConstraints(Long participantId, DateTime effectiveDate) {
		return getRelatedSet(participantId, Constraint.class, effectiveDate);
	}

	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void assignConstraints(Long participantId, Set<Long> constraintIdSet, Long effectiveId) {
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void assignParticipantProgramConstraints(Long participantId, Long programId,
