/* ==================================================================
 * MyBatisOutboundMailDao.java - Jun 18, 2011 8:25:04 PM
 * 
...
/**
 * MyBatis implementation of {@link OutboundMailDao}.
 * 
 * @author matt
 * @version 1.0
 */
public class MyBatisOutboundMailDao
		extends DrasMyBatisFilterableDaoSupport<OutboundMail, Match, OutboundMailFilter>
		implements OutboundMailDao {

	/**
	 * Default constructor.
	 */
	public MyBatisOutboundMailDao() {
	...
	@Override
	protected void postProcessFilterProperties(OutboundMailFilter filter, Map<String, Object> sqlProps) {
