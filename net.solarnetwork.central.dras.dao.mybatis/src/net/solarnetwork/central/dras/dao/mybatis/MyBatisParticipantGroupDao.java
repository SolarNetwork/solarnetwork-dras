/* ==================================================================
 * MyBatisParticipantGroupDao.java - Jun 6, 2011 4:12:12 PM
 * 
...
/**
 * MyBatis implementation of {@link ParticipantGroupDao}.
 * 
 * @author matt
 * @version 1.0
 */
public class MyBatisParticipantGroupDao
		extends DrasMyBatisFilterableDaoSupport<ParticipantGroup, Match, ParticipantGroupFilter>
		implements ParticipantGroupDao {

	/**
	 * Default constructor.
	 */
	public MyBatisParticipantGroupDao() {
		super(ParticipantGroup.class, Match.class);
	}

	@Override
	protected String getFilteredQuery(String filterDomain, ParticipantGroupFilter filter) {
	...
	@Override
	protected void postProcessFilterProperties(ParticipantGroupFilter filter,
	...
	public void assignParticipantMembers(Long programId, Set<Long> participantIdSet, Long effectiveId) {
