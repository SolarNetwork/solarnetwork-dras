/* ==================================================================
 * MyBatisConstraintDao.java - Jun 21, 2011 5:10:33 PM
 * 
...
/**
 * MyBatis implementation of {@link ConstraintDao}.
 * 
 * @author matt
 * @version 1.0
 */
public class MyBatisConstraintDao extends DrasMyBatisGenericDaoSupport<Constraint>
		implements ConstraintDao {

	/**
	 * Default constructor.
	 */
	public MyBatisConstraintDao() {
	...
	public static class ConstraintWindow extends DateTimeWindow {
		...
		private final ConstraintWindowKind kind;
